function dataFileAsStruct = loadDataFile_wavesurfer(filename, formatString, tMin, tMax, minSweepIndex, maxSweepIndex)    
    % loadDataFile L^oads WaveSurfer data into Matlab.
    % 
